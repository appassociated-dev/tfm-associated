Ahora vamos a completar las tablas de **Available Skills** y **Auto-invoke Skills** del scope web.
...
Se debe iterar uno a uno los skills asignados al *scope* web y, para cada uno:
