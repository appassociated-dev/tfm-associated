...
| `mantine-dev` _(nuevo)_         | `itechmeat/llm-code`                     | UI Kit Mantine 8.x - antes gap sin cobertura                                                                      |
| `zod-4` _(nuevo)_               | `gentleman-programming/gentleman-skills` | Validación schemas Zod 4.x                                                                                        |
| `react-hook-form-zod` _(nuevo)_ | `jezweb/claude-skills`                   | Formularios RHF 7 + Zod 4, type-safe                                                                              |
| `sentry-react-setup` _(nuevo)_  | `getsentry/sentry-agent-skills`          | Sentry 10 React: error boundaries, replay, tracing                                                                |
...
| `pwa-development` _(nuevo)_     | `alinaqi/claude-bootstrap`               | vite-plugin-pwa, Service Worker, Workbox strategies, manifest, Lighthouse audit - **cubre RNF-056 completamente** |
