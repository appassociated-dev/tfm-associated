...
* **Opción B:**
  Mantener el **UC-007 en Fase 2**, pero diseñar el **UC-013 en Fase 1** incorporando ya la estructura de `StatusHistory` y las transiciones como parte del *Aggregate Member*, de modo que UC-007 solo añada las transiciones automáticas y la UI de consulta.
