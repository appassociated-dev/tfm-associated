...
↓
RNFT-018 implementa ADR-009 (Capas) + ADR-004 (Domain Events)
↓
BC (Bounded Context)
↓
...
| ADR-004                | RNF-042 (gestión errores en handlers)                   |
| ... (12 filas totales) |
