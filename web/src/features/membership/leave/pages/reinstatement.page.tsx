...
import { Alert, Button, Checkbox, Group, Skeleton, Stack, Table, Text, Title } from '@mantine/core';
...
export function ReinstatementPage() {
  ...
  // Datos
  const { data: summary, isLoading, isError, refetch } = useReinstatementSummary(memberId);
          ...
          <Stack gap="sm">
            ...
            {summary.keepSeniority ? (
              <Alert color="blue" title="Recuperacion de antiguedad">
                Se recuperara la antiguedad anterior ({summary.previousSeniorityMonths} meses).
              </Alert>
            ) : (
